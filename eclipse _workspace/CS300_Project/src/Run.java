...
public class Run extends Activity{
	...
	private double distance; //active/out/questionable
	private int elevHigh; //player statistics for the past season
	private int elevLow;
	private int elevChange;
	
//--//Constructor	
	public Run(Hero playerHero, LocalDate inDate, String inType, double inDuration, int heartRate, int inDist, int elevationHigh, int elevationLow) {
	...
	public Run(Hero playerHero, LocalDate inDate, String inType, double inDuration, int heartRate, double inDist, int elevationHigh, int elevationLow) {
		super(playerHero, inDate, inType, inDuration, 
				heartRate);
		setDistance(inDist);
		setElevHigh(elevationHigh);
